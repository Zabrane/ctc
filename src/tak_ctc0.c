...
#define __opcode	__attribute__((stdcall))
...
__opcode code_ptr_t op_call(code_ptr_t callee, code_ptr_t ra)
{
    PUSH_RA(ra);
    return callee;
}

__opcode code_ptr_t op_jmp(code_ptr_t npc)
{
    return npc;
}

__opcode code_ptr_t op_jgt(code_ptr_t npc)
{
    int x, y;
    POP_INT(x);
    POP_INT(y);
...
#include "ctc_c_separate_naive.h"
#include "ctc_x86_separate_naive.h"
#include "ctc_amd64_separate_naive.h"
#include "ctc_ppc_separate_naive.h"
#include "ctc_sparc_separate_naive.h"
#include "ctc_arm_separate_naive.h"
